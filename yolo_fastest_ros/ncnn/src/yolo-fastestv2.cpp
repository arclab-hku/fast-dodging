...
int yoloFastestv2::loadParams(bool gpu_flag, int size, float thresh1, float thresh2)
{
    //if use gpu
    useGpu = gpu_flag;
    ...
    //anchor box w h
    std::vector<float> bias {9.41,13.06, 15.01,20.25, 30.09,33.22, 66.85,58.63, 97.75,94.69, 146.39,169.30};
...
{   
    ...
    //特征图后处理
    predHandle(out, tmpBoxes, scaleW, scaleH, confThresh);
